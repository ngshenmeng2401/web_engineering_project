...
include("dbconnect.php");
    ...
    if(isset($_POST['edit_user_profile'])){
        ...
        {
          echo "<script type='text/javascript'>alert('Success!');window.location.assign('admin_profile_screen.php');</script>'";
        }else{
          echo "<script type='text/javascript'>alert('Failed!!');window.location.assign('admin_profile_screen.php');</script>'";
        }
        ...
        if(!isset($file)){
            echo "<script type='text/javascript'>alert('Please upload an image');window.location.assign('admin_profile_screen.php');</script>'";
        }else{
...
<head>
<meta charset="utf-8">
<title>admin_profile_screen</title>
<link rel="stylesheet" href="../css/admin_profile_screen.css">
	...
	<div class="body">
		<div class="body_part1">
			<div class="body_part1_1">
				<div class="body_part1_1_1">
					<h2>MY PROFILE</h2>
				</div>
				<div class="body_part1_1_2">
					<div class="body_part1_1_2_1">
						<h3>Manage Your Account</h3>
					</div>
					<div class="body_part1_1_2_2">
						<div class="body_part1_1_2_2_1">
							<h3 for="name" style="margin-top: 10px">Name</h3>
							<h3 for="email">Email</h3>
							<h3 for="phone_no">Phone No</h3>
							<h3 for="gender">Gender</h3>
						</div>
						<div class="body_part1_1_2_2_2">
						    <?php
                                session_start();
                                error_reporting(0);
                                include("dbconnect.php");
